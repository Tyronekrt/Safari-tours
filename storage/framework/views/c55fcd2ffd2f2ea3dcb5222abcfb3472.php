                ...
                <div class="card bg-primary text-white">
                    <div class="card-body py-5">
                        ...
                        <div class="d-flex justify-content-center gap-3">
                            <a href="<?php echo e(route('packages.index')); ?>" class="btn btn-light btn-lg">Browse Packages</a>
                            <a href="<?php echo e(route('enquiry.create')); ?>" class="btn btn-outline-light btn-lg">Contact Us</a>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/kelvin/Projects/Safari/resources/views/about.blade.php ENDPATH**/ ?>