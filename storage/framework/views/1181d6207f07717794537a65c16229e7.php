    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <p style="text-align: center; background-color: #f8f9fa; padding: 20px; border-radius: 5px; margin: 20px 0;">
                <span style="font-size: 32px; font-weight: bold; letter-spacing: 5px; color: #2d5a27;"><?php echo e($verificationCode); ?></span>
            </p>
        ...
        <div class="footer">
            <p>&copy; <?php echo e(date('Y')); ?> Safari Tours. All rights reserved.</p>
            <p>This is an automated email, please do not reply.</p>
        </div>
    </div>
</body>
</html><?php /**PATH /home/kelvin/Projects/Safari/resources/views/emails/email-verification.blade.php ENDPATH**/ ?>